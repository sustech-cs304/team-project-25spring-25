...
public class PrometeoEditor : Editor
{
    ...
    // 新增氮气加速相关字段
    private SerializedProperty nitroCapacity;
    private SerializedProperty nitroConsumptionRate;
    private SerializedProperty nitroRechargeRate;
    private SerializedProperty nitroBoostMultiplier;
    ...
    private void OnEnable()
    {
        ...
        NitroParticleSystem = SO.FindProperty("NitroParticleSystem");
        ...
        // 初始化氮气加速相关字段
        nitroCapacity = SO.FindProperty("nitroCapacity");
        nitroConsumptionRate = SO.FindProperty("nitroConsumptionRate");
        nitroRechargeRate = SO.FindProperty("nitroRechargeRate");
        nitroBoostMultiplier = SO.FindProperty("nitroBoostMultiplier");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(NitroParticleSystem, new GUIContent("Nitro Particle System: "));
        ...
        GUILayout.Space(25);
        GUILayout.Label("NITRO BOOST", EditorStyles.boldLabel);
        GUILayout.Space(10);

        nitroCapacity.floatValue = EditorGUILayout.FloatField("Nitro Capacity:", nitroCapacity.floatValue);
        nitroConsumptionRate.floatValue = EditorGUILayout.FloatField("Nitro Consumption Rate:", nitroConsumptionRate.floatValue);
        nitroRechargeRate.floatValue = EditorGUILayout.FloatField("Nitro Recharge Rate:", nitroRechargeRate.floatValue);
        nitroBoostMultiplier.floatValue = EditorGUILayout.FloatField("Nitro Boost Multiplier:", nitroBoostMultiplier.floatValue);
